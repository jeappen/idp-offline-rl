...
if __name__ == "__main__":
    ...
    setup(name="d3rlpy",
          version=__version__,
          description="Information-Directed Pessimism for Offline Reinforcement Learning",
          long_description=open("README.md").read(),
          long_description_content_type="text/markdown",
          url="https://github.com/jeappen/idp-offline-rl",
          author="Joe Eappen, Takuma Seno, and others",
          author_email="joe.eappn@gmail.com",
          license="MIT License",
